...
const token =
  "pk.eyJ1Ijoia3lsZWRuZiIsImEiOiJjanNtY292M3MwMDZpNGFwcDVmeWdzY2x0In0.0jn7l6NogZPfjRuaHzoxGg";
...
const Map = ({ classes }) => {
  ...
  const highlightNewPin = pin => {
    const isNewPin =
      differenceInMinutes(Date.now(), Number(pin.createdAt)) <= 30; //  pin is less than or equal to 30 minutes old
